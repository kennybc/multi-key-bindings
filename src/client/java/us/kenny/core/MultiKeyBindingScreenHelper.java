...
public final class MultiKeyBindingScreenHelper {
     ...
     */
    public static boolean handleMouseClicked(MultiKeyBindingScreen screen, KeyBindsList list, int button) {
        InputConstants.Key pressedKey = InputConstants.Type.MOUSE.getOrCreate(button);
     ...
     */
    public static boolean handleKeyPressed(MultiKeyBindingScreen screen, KeyBindsList list,
            InputConstants.Key pressedKey) {
        KeyMapping selectedKey = screen.getSelectedKey();
        MultiKeyBinding selectedMultiKeyBinding = screen.getSelectedMultiKeyBinding();

        if (pressedKey.getType() == InputConstants.Type.KEYSYM
                && pressedKey.getValue() == InputConstants.KEY_ESCAPE) {
            if (selectedKey != null) {
